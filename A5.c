...
#define rs PORTBbits.RB6            // LCD Control pins
#define rw PORTBbits.RB7
...
void main(void) {
    ...
    CCP1CON             = 0;
    PR2                 = 249;
    CCPR1L              = speed * 250 / 100 ;  //75% duty cycle
    T2CON               = 0x01;//timer 2 and 4 prescalar no postscaler
    CCP1CON             = 0x3C; 
    TMR2                = 0;
    T2CON               = 0b00000101;
    ...
    while(1){            
        ...
        PIR1 = 0b00000000;  // clear timer flag
        while(PIR1 == 0); // wait for end of period    
        ...
        for(i = 0; i <= 4; i++){
            ...
            if(r != ' '){
                ...
                j++;  
                __delay_ms(70);            // Delay to stop repeated key presses
            }
            ...
            if(r == 'D'){                   // If press button D
                ...
                speed = atoi(data);           // num is int for motor values (converted from keypad)
                CCPR1L              = speed * 250 / 100 ;  //75% duty cycle 
